            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative group">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-base text-gray-600">Solutions complétes pour votre déménagement.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600 italic">
                  {`Mon déménagement s'est déroulé parfaitement gràce à Pro-Trans. J'ai pu suivre mon mobilier en temps réel et le transporteur était trés professionnel. Je recommande !`}
                </p>
              </div>
            </div>
          </div>
