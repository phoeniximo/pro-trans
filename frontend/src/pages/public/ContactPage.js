...
const ContactPage = () => {
  ...
  const validationSchema = Yup.object({
    ...
    telephone: Yup.string()
      .matches(/^((\+)33|0)[1-9](\d{2}){4}$/, 'Format de téléphone invalide (ex: 0612345678 ou +33612345678)')
      .notRequired(),
            ...
            <div className="mt-9">
              ...
              <div className="mt-6 flex">
                ...
                <div className="ml-3 text-base text-gray-500">
                  ...
                  <p className="mt-1">Réponse sous 24h ouvrées</p>
                </div>
              </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8">
              {submitSuccess ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                  ...
                  <h2 className="text-2xl font-medium text-gray-900 mb-2">Message envoyé !</h2>
